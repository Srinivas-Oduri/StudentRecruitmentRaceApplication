...
class RaceActivity : AppCompatActivity() {
    ...
    override fun onCreateOptionsMenu(menu: Menu?): Boolean {
        menuInflater.inflate(R.menu.race_menu, menu)
        return super.onCreateOptionsMenu(menu)
    }
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            R.id.profile -> {
                startActivity(Intent(this@RaceActivity, ProfileActivity::class.java))
            }
            R.id.about -> {
                startActivity(Intent(this@RaceActivity, AboutActivity::class.java))
            }
            R.id.logout -> {
                logoutUser()
            }
            R.id.info -> {
                startActivity(Intent(this@RaceActivity, UserInformationActivity::class.java))
            }
        }
